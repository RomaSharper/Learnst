...
public class MailRuUserInfo
{
    ...
    [JsonPropertyName("patronymic")] public string Patronymic { get; set; } = string.Empty;
    ...
    [JsonPropertyName("default_avatar_id")] public string DefaultAvatarId { get; set; } = string.Empty;
}
