        ...
        Expression<Func<T, TResult?>>? selector = null)
    {
        ...
        switch (function)
        {
            case EFHelper.AggregateFunction.Count:
                ...
                return await EFHelper.CountAsync<T, TResult>(query);
