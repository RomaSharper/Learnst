...
export class SocialMediaPlatformHelper {
  static getName(platform: SocialMediaPlatform): string {
    switch (platform) {
      ...
      case SocialMediaPlatform.Google:
        return 'Google';
      case SocialMediaPlatform.Microsoft:
        return 'Microsoft';
      case SocialMediaPlatform.Yandex:
        return 'Yandex';
      case SocialMediaPlatform.MailRu:
        return 'Mail.ru';
      case SocialMediaPlatform.Ok:
  ...
  static getImagePath(platform: SocialMediaPlatform | string): string {
    ...
    switch (platform) {
      case SocialMediaPlatform.Bluesky:
        return base + 'bluesky.png';
      case SocialMediaPlatform.Discord:
        return base + 'discord.png';
      case SocialMediaPlatform.Facebook:
        return base + 'facebook.png';
      case SocialMediaPlatform.Github:
        return base + 'github.png';
      case SocialMediaPlatform.Instagram:
        return base + 'instagram.png';
      case SocialMediaPlatform.LinkedIn:
        return base + 'linkedin.png';
      case SocialMediaPlatform.Tumblr:
        return base + 'tumblr.png';
      case SocialMediaPlatform.Roblox:
        return base + 'roblox.png';
      case SocialMediaPlatform.Telegram:
        return base + 'telegram.png';
      case SocialMediaPlatform.Twitter:
        return base + 'x.png';
      case SocialMediaPlatform.VK:
        return base + 'vk.png';
      case SocialMediaPlatform.Youtube:
        return base + 'youtube.png';
      case SocialMediaPlatform.Steam:
        return base + 'steam.png';
      case SocialMediaPlatform.Twitch:
        return base + 'twitch.png';
      case SocialMediaPlatform.EpicGames:
        return base + 'epic-games.png';
      case SocialMediaPlatform.Reddit:
        return base + 'reddit.png';
      case SocialMediaPlatform.Pinterest:
        return base + 'pinterest.png';
      case SocialMediaPlatform.Snapchat:
        return base + 'snapchat.png';
      case SocialMediaPlatform.TikTok:
        return base + 'tiktok.png';
      case SocialMediaPlatform.Google:
        return base + 'google.png';
      case SocialMediaPlatform.Microsoft:
        return base + 'microsoft.png';
      case SocialMediaPlatform.Yandex:
        return base + 'yandex.png';
      case SocialMediaPlatform.MailRu:
        return base + 'mail-ru.png';
      case SocialMediaPlatform.Ok:
        return base + 'ok.png';
      case SocialMediaPlatform.Apple:
        return base + 'apple.png';
      default:
